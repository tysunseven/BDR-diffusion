...
python3 acoustic_train.py --run_timestamp $RUN_TIMESTAMP --results_folder $RESULT_FOLDER --data_class microstructure --name model --batch_size 256 --continue_training $CONTINUE_TRAINING --image_size 128 --training_epoch 200 --ema_rate 0.999 --base_channels 32 --save_last True --save_every_epoch 50 --with_attention True  --split_dataset False  --lr 1e-4 --optimizier adamw --img_folder /root/autodl-fs